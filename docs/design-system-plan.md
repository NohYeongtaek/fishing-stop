...
## 완료 기준
- [ ] Phase 0: 토큰 파일 + 테마 개편 + 폰트 + density 해킹 제거, 빌드 통과
- [ ] Phase 1: 공통 위젯 세트, 일반/어르신 토큰 반영
- [ ] Phase 2: 12개 화면 토큰 적용 (**기존 인터랙션 보존**: 홈 물결 애니메이션·탭바 색 변화 선택 표시 유지)
- [ ] Phase 3: 어르신 레이아웃 분기
- [ ] 실기기: 일반/어르신 × 라이트/다크 4조합 육안 확인
