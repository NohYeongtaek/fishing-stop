...
import com.example.fishingstop.feature.consent.domain.SetConsentUseCase
...
class ConsentViewModel @Inject constructor(
    ...
    private val consentRepository: com.example.fishingstop.feature.consent.domain.ConsentRepository
) : ViewModel() {
